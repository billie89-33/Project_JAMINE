...
15. **พิมพ์เขียวระบบสินค้า (Product Blueprint & API):** [docs/15-product-schema-blueprint.md](./docs/15-product-schema-blueprint.md)
    - *ใช้อ่านเมื่อ:* ต้องการดูโครงสร้างฐานข้อมูลสินค้าทั้งหมด, แก้ไขบัคเกี่ยวกับ Sidebar (หมวดหมู่/แบรนด์ไม่ขึ้น), หรือสร้าง API ฝั่ง Backend เพิ่มเติม
